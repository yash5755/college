...
final facultyTimetableProvider = StreamProvider<List<TimetableEntry>>((ref) {
...
class FacultyTimetableScreen extends ConsumerWidget {
  const FacultyTimetableScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final timetableAsync = ref.watch(facultyTimetableProvider);
                    ...
                    return ListTile(
                      ...
                      trailing: Column(
                        ...
                        children: [
                          ...
                          if (entry.section != null) Text('Section: ${entry.section}', style: const TextStyle(fontSize: 12)),
                        ],
                      ),
                    );
                  }).toList(),
